...
@Composable
private fun LicensesScreen(libraries: Libs? = null) {
    Scaffold { paddingValues ->
        LibrariesContainer(
            modifier = Modifier.fillMaxSize().testTag("licences:licence_list"),
            libraries = libraries,
            ...
            libraries =
                listOf(
                    Library(
                        ...
                        description =
                            "This is a fantastic fake library used for previewing UI components.",
                        ...
                        licenses =
                            setOf(
                                License(
                                    ...
                                    year = "2024",
                                    licenseContent =
                                        "Standard Apache 2.0 License content here...", // Fixed:
                                    // Renamed
                                    // from
                                    // content
                                )
            ...
            licenses =
                setOf(
                    License(
                        ...
                        year = "2024",
                        licenseContent =
                            "Standard Apache 2.0 License content here...", // Fixed: Renamed from
                        // content
                    )
                ),
        )
