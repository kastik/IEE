...
fun NavGraphBuilder.authenticationScreen(navigateBack: () -> Unit) {
    composable<AuthRoute>(
        deepLinks = listOf(navDeepLink<AuthRoute>(basePath = "com.kastik.apps://auth")),
        enterTransition = { scaleIn() },
        exitTransition = { fadeOut() },
        popEnterTransition = { fadeIn() },
    ) { backStackEntry ->
        AuthenticationRoute(navigateBack = navigateBack)
    }
}
