...
val baseAnnouncementDto = AnnouncementDto(
    id = 1,
...
val baseSingleResponseAnnouncementDto = SingleResponseDto<AnnouncementDto>(
    data = baseAnnouncementDto
)

internal val basePagedAnnouncementMetaDto = PagedMetaDto(
    currentPage = 1,
    lastPage = 1,
...
val basePagedAnnouncementDto = PagedResponseDto<AnnouncementDto>(
