...
internal class WorkSchedulerImpl @Inject constructor(
    ...
    override fun scheduleStartupSync() {
        ...
        val oneTimeSyncRequest = OneTimeWorkRequestBuilder<StartupSyncWorker>()
    ...
    override fun scheduleSubscribeToTags(ids: List<Int>) {
        ...
        val inputData = Data.Builder()
            .putIntArray(KEY_TAG_IDS, ids.toIntArray())
            .build()

        val subscribeWorkRequest = OneTimeWorkRequestBuilder<SubscribeWorker>()
            .setExpedited(OutOfQuotaPolicy.RUN_AS_NON_EXPEDITED_WORK_REQUEST)
            .setConstraints(constraints)
    ...
    override fun scheduleAnnouncementSync(announcementId: Int) {
        ...
        val inputData = Data.Builder()
            .putInt(KEY_ANNOUNCEMENT_ID, announcementId)
            .build()

        val syncAnnouncementWorkRequest = OneTimeWorkRequestBuilder<AnnouncementSyncWorker>()
            .setExpedited(OutOfQuotaPolicy.RUN_AS_NON_EXPEDITED_WORK_REQUEST)
            .setConstraints(constraints)
            .setInputData(inputData)
            .setBackoffCriteria(
