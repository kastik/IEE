...
class AnnouncementRemoteMediatorTest {
    ...
    // fakeAppDatabase.announcementDao().getPagedAnnouncements() }
    ...
    //        )
    //        val dbPageOne = fakeAppDatabase.fakeAnnouncementDao.getPagedAnnouncements()
    //        assertThat(dbPageOne).containsExactlyElementsIn(apiPageOne.data.map {
    // it.toAnnouncementEntity() })
    //    }
    //
    //    @Test
    //    fun refreshReturnsSuccessWithEndOfPaginationToFalseWhenMorePageAreAvailableTest() =
    // runTest
    // {
    ...
    //                        attachments = announcementDto.attachments.map {
    // it.toAttachmentEntity()
    // },
    //                    )
    //                },
