...
class GetOnboardStageUseCase @Inject constructor(private val onboardRepository: OnboardRepository) {
    operator fun invoke() = onboardRepository.currentOnboardingOnboardStage
}

class GetHasFinishedOnboardUseCase
@Inject
constructor(private val onboardRepository: OnboardRepository) {
    operator fun invoke() = onboardRepository.hasFinishedOnboarding
}

class SetHasFinishedOnboardUseCase
@Inject
constructor(private val onboardRepository: OnboardRepository) {
...
class SetOnboardStageUseCase @Inject constructor(private val onboardRepository: OnboardRepository) {
